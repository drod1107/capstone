...
<h3>Who are you?</h3>
<label>Email address</label><input type="text" placeholder="name@domain.com"><br>
<label>Password</label><input type="password" placeholder="Create Password"><br>
<label>First Name</label><input type="text"><label>Last Name</label><input type="text">
...
<label>If you're an owner, enter your gym's name here: </label><input type="text">
...
<div class="contact">
    ...
    <label for="contact3">Carrier Pigeon. Seriously? Just leave me alone. Ugh.</label>
</div>
<div class="signUpForm preferences">
    ...
    <div>
        <input type="checkbox" id="resistanceTraining" name="resistanceTraining">
...
<div id="frequency">
    ...
    <div>
        ...
        <label for="daily">Every darned day, baby. My mail gets delivered to my gym.</label>
    </div>
</div>
<div id="experience">
    ...
    <div>
            ...
            <label for="returning">Fell off the wagon but I'm climbing back up.</label>
    </div>
    <div>
    ...
    <div>
        ...
        <label for="professional">This is literally - not figuratively - my job. I'm basically a Jedi, thanks.</label>
    </div>
</div>
</div>
